...
seed_I<-seeded.intervals(66,decay = sqrt(2))
seed_I<-seed_I[(seed_I[,2]-seed_I[,1])>minLen,]
seed_I<-seed_I
path<-paste('seed_I_1_66_minLen10.Rdata')
save(seed_I, file=path)

seed_I<-seeded.intervals(232-120,decay = sqrt(2))
seed_I<-seed_I[(seed_I[,2]-seed_I[,1])>minLen,]
seed_I_2<-seed_I+120
path<-paste('seed_I_121_232_minLen10.Rdata')
